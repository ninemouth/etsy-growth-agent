...
globalThis.fetch = async (url, options = {}) => {
  ...
  if (pathname === "/api/etsy/integration") {
    body = { integration: { contractVersion: "marqel-etsy-api-status.v1", configured: true, canConfigure: false, appType: "seller", credentialStatus: "verified", oauthStatus: "connected", keystring: { last4: "7890" }, scopes: ["shops_r", "listings_r"], shop: { id: "24680", name: "Owner Shop" }, accessState: "active", refreshState: "active", credentialDelivery: "server_only", dataProxy: { status: "read_only", source: "etsy_official_api", resources: ["active_listings", "listing_details"], unsupported: ["receipts", "ads"] }, externalActionPerformed: false } };
