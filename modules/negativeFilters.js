...
// modules/negativeFilters.js — Dynamic "do-not-sell" negative filter for small/micro sellers on Etsy
...
export const DEFAULT_NEGATIVE_FILTERS = [
  ...
  },
  {
    ...
    rationale: "Etsy 自发货/跨境履约成本对小微卖家是硬约束。体积重高、易碎、需特殊包装的品类会侵蚀利润并提高破损率。",
    examples: ["大件家具", "大型健身器材", "陶瓷玻璃制品", "液体/膏体/粉末", "超长异形件"],
    appliesTo: ["sourcing", "product_opportunity", "platform_trend"],
  },
  {
    id: "nf_compliance_barrier",
    title: "CE/CPC/FDA/FCC/REACH/CPSIA 等强制认证壁垒",
    rationale: "欧美对婴童、电器、化妆品、食品接触、医疗器械、电池等品类有强制认证。小微卖家若无稳定供应链配合取证，应回避或标注为高风险待验证。",
  ...
  },
  {
    ...
    examples: ["服装", "鞋靴", "内衣", "珠宝配饰（尺寸敏感款）", "假发", "主观审美依赖的装饰品"],
  ...
  },
  {
    ...
    examples: ["知名品牌仿品", "迪士尼/漫威/动漫/影视角色周边", "专利外观近似款", "未授权商标关键词"],
    appliesTo: ["sourcing", "product_opportunity", "platform_trend", "listing_generator", "compliance"],
  },
  {
    id: "nf_platform_restricted",
    title: "Etsy 平台禁限售或需特殊资质",
    rationale: "即使法律允许，Etsy 平台也可能禁售或要求特殊类目资质。必须在平台政策层面做二次确认。",
    examples: ["成人用品", "医疗器械", "药品/保健品", "危险品", "动物制品（濒危/受限）", "政治敏感品"],
    appliesTo: ["sourcing", "product_opportunity", "platform_trend", "compliance"],
  },
  {
    id: "nf_local_commodity",
    title: "欧美本地易购普通日杂标品",
    rationale: "本地易购、物流成本低、无差异化的普通标品很难在跨境场景建立溢价优势。",
    examples: ["普通纸巾", "基础调味品", "低端日杂", "本地品牌主导的日用品", "无设计感的标准文具"],
    appliesTo: ["sourcing", "product_opportunity", "platform_trend"],
  },
  {
    ...
    examples: ["手机壳膜红海款", "数据线/充电器通用款", "标准化 3C 配件", "平台自营强势品类"],
  ...
  },
  {
    id: "nf_local_service",
    title: "需本地安装/售后/保修服务",
    rationale: "跨境卖家难以提供欧美本地安装、维修、质保服务，这类商品售后风险极高。",
...
export function buildNegativeFilterPrompt(skillId = "", userInstruction = "") {
  ...
  const relevantDefault = DEFAULT_NEGATIVE_FILTERS.filter((filter) =>
    ...
    normalizedSkill.includes("etsy_")
  );
